      ...
      PARAMETER (NTENS=6,NDI=3,NSTATV=20,NPROPS=10)
...
C 210 subroutine to cal deviatoric stress
      ...
      !INCLUDE 'ABA_PARAM.INC'
      PARAMETER(ZERO=0.D0, THREE=3.D0, TOLER=1.D-6, N=40)
      REAL*8 EFF_STRESS,G,DEL_P,P,P_OLD,D_DEL_P
      P= P_OLD
      TERM1= EFF_STRESS-THREE*G*DEL_P-H*P-YS
      K= 1
      DO WHILE (K.LT.N.AND.ABS(TERM1).GT.(TOLER))
          P= P+ DEL_P
          TERM1= EFF_STRESS-THREE*G*DEL_P-H*P-YS
